...
# Upload data
harga_file = st.file_uploader("C:\Users\Eunike Bunga\Downloads\Harga_Gabah_2019-2024 (3).csv", type="csv")
padi_file = st.file_uploader("c:\Users\Eunike Bunga\Downloads\Data_Padi_2019_2024_Cleaned.csv", type="csv")
